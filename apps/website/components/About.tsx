      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        ...
        <div className="mt-8 md:mt-12 mb-32 relative">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12 items-stretch">
            ...
            {/* Info Column - 8/12 Grid */}
            <div className="md:col-span-8 flex flex-col">
               {/* Name Block - Slightly more spacing to balance */}
               <div className="mb-6">
               ...
               {/* Quote Block - Optimized Padding & Readability */}
               <div className="relative w-full mb-8 flex-1 flex flex-col">
                  <GlassCard variant="solid" className="flex-1 p-8 md:p-10 bg-white/50 dark:bg-zinc-900/40 border-brand-500/10 relative overflow-hidden shadow-xl w-full flex flex-col justify-center">
                    ...
                    <div className="space-y-6">
                      ...
                      {/* Emphasized Quote: No more truncation, better spacing */}
