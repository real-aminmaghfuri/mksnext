          ...
          <div className="mb-6 relative">
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-8">
                ...
                {/* EMPHASIS CONTAINER - Orange 500 with 10% Opacity + Dark/Adaptive Text */}
                <div className="p-6 md:px-10 md:py-8 rounded-2xl bg-orange-500/10 border-l-[6px] border-brand-600 shadow-sm backdrop-blur-md">
