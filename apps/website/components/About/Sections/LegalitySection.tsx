            ...
            <div className="lg:col-span-8 p-6 md:p-10 space-y-6 md:space-y-0">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between py-4 border-b border-zinc-200 dark:border-zinc-800 border-dashed">
                    ...
                    <div className="flex items-center gap-2 mt-2 md:mt-0">
                        ...
                        <span className="text-zinc-900 dark:text-white font-bold tracking-tight text-lg">{content.valueEntity}</span>
                    </div>
                </div>
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between py-4">
                    ...
                    <div className="text-right mt-2 md:mt-0">
                        <p className="text-zinc-900 dark:text-white font-mono font-bold text-lg">{content.values.bank}</p>
