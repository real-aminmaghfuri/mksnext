    ...
    <div className="mb-20 md:mb-28 relative max-w-4xl">
      <div className="flex flex-col gap-6 md:gap-8">
        ...
        <div className="flex items-center gap-4 md:gap-8 mb-4">
            ...
            <h2 className="text-3xl md:text-5xl font-black text-zinc-900 dark:text-white tracking-tighter leading-none uppercase">
                {content.title}
            </h2>
        </div>
        ...
        <div className="space-y-10 pl-8 md:pl-12 border-l-[1px] border-zinc-200 dark:border-zinc-800/50">
            <p className="text-base md:text-xl leading-relaxed text-zinc-600 dark:text-zinc-400 font-medium opacity-90">
                {content.p1}
