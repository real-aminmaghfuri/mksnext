  ...
  return (
    <div className="container mx-auto px-6 py-24">
      ...
      <div className="text-center mb-16">
         <div className="inline-block px-3 py-1 rounded bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 text-[10px] font-black text-brand-600 uppercase tracking-widest mb-4">
             PREMIUM ARSENAL
         </div>
         <h2 className="text-4xl md:text-5xl font-black text-zinc-900 dark:text-white uppercase tracking-tighter mb-4">
            {roleTitle.split(' ')[0]} <span className="text-brand-600 dark:text-brand-500">{roleTitle.split(' ')[1]}</span>
         </h2>
      ...
      <div className="max-w-4xl mx-auto">
        <div className="relative p-1 rounded-3xl bg-gradient-to-b from-zinc-200 to-zinc-50 dark:from-zinc-800 dark:to-black overflow-hidden group shadow-xl dark:shadow-none">
            ...
            <div className="relative rounded-[20px] bg-white dark:bg-black p-12 md:p-20 text-center flex flex-col items-center">
                ...
                <h3 className="text-2xl md:text-3xl font-black text-zinc-900 dark:text-white uppercase tracking-tight mb-4">
                    {forceHireTitle}
                </h3>
                ...
                <Button className="bg-brand-600 hover:bg-brand-500 text-white font-black uppercase tracking-widest px-8 py-4 shadow-lg shadow-brand-600/30 dark:shadow-brand-900/50">
                    {forceHireBtn}
                </Button>
