...
export const ProfileRealityAtom: React.FC<ProfileRealityProps> = ({ content }) => {
  return (
    <div className="py-24 bg-red-50 dark:bg-red-950/10 relative overflow-hidden">
        <div className="container mx-auto px-6 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="bg-white dark:bg-black p-8 rounded-3xl border border-red-200 dark:border-red-900/30 shadow-xl">
