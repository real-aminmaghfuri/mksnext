...
export const ProfileCtaAtom: React.FC<ProfileCtaProps> = ({ content }) => {
  return (
    <div className="py-24 bg-zinc-900 dark:bg-zinc-950 relative overflow-hidden border-t border-zinc-800">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
            ...
            <a href="https://wa.me/628816566935?text=Halo%20MKS,%20saya%20mau%20bikin%20website%20Company%20Profile%20yang%20gahar." target="_blank" rel="noopener noreferrer">
                <Button size="lg" className="bg-gradient-to-r from-brand-600 to-red-600 hover:to-red-500 text-white font-black tracking-widest uppercase px-10 py-5 shadow-2xl shadow-brand-900/50">
