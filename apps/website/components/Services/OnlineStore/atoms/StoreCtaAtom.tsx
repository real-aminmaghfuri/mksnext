...
export const StoreCtaAtom: React.FC<StoreCtaProps> = ({ content }) => {
  return (
    <div className="py-24 bg-gradient-to-br from-zinc-900 to-black relative overflow-hidden border-t border-zinc-800">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-emerald-600/10 blur-[100px] rounded-full pointer-events-none" />
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
            ...
            <a href="https://wa.me/628816566935?text=Halo%20MKS,%20saya%20tertarik%20bikin%20Web%20Toko%20Online%20Auto-Pilot." target="_blank" rel="noopener noreferrer">
                <Button size="lg" className="bg-gradient-to-r from-emerald-600 to-teal-600 hover:to-teal-500 text-white font-black tracking-widest uppercase px-10 py-5 shadow-2xl shadow-emerald-900/50">
