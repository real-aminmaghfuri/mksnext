...
export const WebAppCtaAtom: React.FC<WebAppCtaProps> = ({ content }) => {
  return (
    <div className="py-24 bg-gradient-to-b from-black to-zinc-900 relative overflow-hidden border-t border-zinc-800">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
            ...
            <a href="https://wa.me/628816566935?text=Halo%20MKS,%20saya%20tertarik%20bangun%20Sistem%20Custom." target="_blank" rel="noopener noreferrer">
                <Button size="lg" className="bg-gradient-to-r from-blue-600 to-cyan-600 hover:to-cyan-500 text-white font-black tracking-widest uppercase px-10 py-5 shadow-2xl shadow-blue-900/50">
