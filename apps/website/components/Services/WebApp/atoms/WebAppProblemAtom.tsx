...
export const WebAppProblemAtom: React.FC<WebAppProblemProps> = ({ content }) => {
  return (
    <div className="py-24 bg-zinc-950 border-y border-zinc-900 relative">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="space-y-6">
                    {content.items.map((item, idx) => (
                        <div key={idx} className="group p-6 rounded-2xl bg-zinc-900 border border-zinc-800 hover:border-blue-500/50 transition-colors">
                            <div className="flex items-start gap-4 mb-3 opacity-60 group-hover:opacity-100 transition-opacity">
                                ...
                                <p className="text-zinc-400 font-medium text-sm line-through decoration-red-500/50">
                                    {item.problem}
                                </p>
                            </div>
