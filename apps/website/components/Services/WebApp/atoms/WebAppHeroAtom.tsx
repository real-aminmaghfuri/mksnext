...
export const WebAppHeroAtom: React.FC<WebAppHeroProps> = ({ content }) => {
  return (
    <div className="pt-40 pb-24 relative overflow-hidden bg-zinc-50 dark:bg-black border-b border-zinc-200 dark:border-zinc-900 transition-colors duration-500">
       ...
       <div className="absolute inset-0 bg-[linear-gradient(to_right,#e4e4e7_1px,transparent_1px),linear-gradient(to_bottom,#e4e4e7_1px,transparent_1px)] dark:bg-[linear-gradient(to_right,#1d4ed81a_1px,transparent_1px),linear-gradient(to_bottom,#1d4ed81a_1px,transparent_1px)] bg-[size:40px_40px]" />
       
       <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-blue-500/5 dark:bg-blue-600/10 rounded-full blur-[120px] pointer-events-none" />
       
       <div className="container mx-auto px-6 relative z-10 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 text-blue-600 dark:text-blue-400 text-xs font-black animate-fade-in-up mx-auto shadow-sm mb-8 uppercase tracking-widest">
             <Terminal size={14} />
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-black text-zinc-900 dark:text-white uppercase tracking-tighter mb-8 leading-[0.85]">
            {content.title} <br/>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-500 dark:from-blue-500 dark:to-cyan-400">{content.titleSpan}</span>
          </h1>
          ...
          {/* Decorative Code Block - Keep Dark for Contrast/Tech feel even in Light Mode */}
          <div className="mt-16 max-w-2xl mx-auto bg-zinc-900 border border-zinc-800 rounded-xl p-4 text-left shadow-2xl">
