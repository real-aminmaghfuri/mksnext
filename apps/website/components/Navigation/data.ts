...
export const getMenuStructure = (text: Translation): MenuItem[] => [
  ...
  { 
    ...
    columns: [
      {
         title: text.navAboutCompany, // "PERUSAHAAN" (Was Profil)
         width: 'wide', // Takes 3 columns
         items: [
      ...
      {
         title: text.navInnoHeader, // "INOVASI" (Rightmost)
         width: 'narrow', // Takes 1 column
         items: [
  ...
  { 
    ...
    hasDropdown: true,
    items: [
      { label: text.navHwBundle, path: '/shop', icon: Package, desc: "Paket Siap Pakai (All-in-One)" }, // New First Item
      ...
      { label: text.navHwDrawer, path: '/shop', icon: Inbox, desc: "Laci Uang (Metal/RJ11)" }, // New Item
  ...
  { 
    ...
    columns: [
        {
            title: text.navSupLegalHeader, // "ATURAN MAIN" (Moved Left)
            width: 'narrow',
            items: [
        ...
        {
            title: text.navSupHeader, // "BANTUAN" (Moved Right & Merged)
            width: 'wide', // Give it space as it now has more items
            items: [
