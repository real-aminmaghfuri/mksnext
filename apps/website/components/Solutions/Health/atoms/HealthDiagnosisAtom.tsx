...
export const HealthDiagnosisAtom: React.FC<HealthDiagnosisProps> = ({ content }) => {
  return (
        ...
        <div className="container mx-auto px-6 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {content.points.map((point, idx) => (
                    <div key={idx} className="bg-white dark:bg-black p-8 rounded-3xl border border-red-200 dark:border-red-900/30 shadow-lg dark:shadow-none flex flex-col items-center text-center group hover:scale-105 transition-transform duration-300 relative overflow-hidden">
