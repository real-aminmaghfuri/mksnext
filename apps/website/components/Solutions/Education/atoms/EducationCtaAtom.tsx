...
export const EducationCtaAtom: React.FC<EducationCtaProps> = ({ content }) => {
  return (
    <div className="py-24 bg-gradient-to-br from-zinc-900 to-black relative overflow-hidden border-t border-zinc-800 transition-colors duration-500">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
            ...
            <a href="https://wa.me/628816566935?text=Halo%20MKS,%20saya%20tertarik%20solusi%20untuk%20Sekolah/Yayasan." target="_blank" rel="noopener noreferrer">
                <Button size="lg" className="bg-cyan-600 hover:bg-cyan-500 text-white font-black tracking-widest uppercase px-10 py-5 shadow-2xl shadow-cyan-500/30">
                    <School size={20} className="mr-2" /> {content.btn}
                </Button>
            </a>
        </div>
    </div>
