          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
             {content.features.map((item, idx) => {
                ...
                return (
                   ...
                   >
                      <div className="w-16 h-16 shrink-0 rounded-2xl bg-zinc-100 dark:bg-zinc-800 flex items-center justify-center text-zinc-900 dark:text-white group-hover:bg-red-600 group-hover:text-white transition-colors duration-300 border border-zinc-200 dark:border-zinc-700 group-hover:border-red-500">
