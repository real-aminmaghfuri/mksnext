    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-20">
          ...
          <div className="flex p-1 bg-zinc-100 dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800">
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-lg text-[10px] font-black uppercase tracking-widest transition-all
                ${viewMode === 'EDIT' ? 'bg-white dark:bg-zinc-800 text-brand-600 shadow-sm' : 'text-zinc-500 hover:text-zinc-700'}`}
            >
              <Edit3 size={12} /> Edit
            </button>
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-lg text-[10px] font-black uppercase tracking-widest transition-all
                ${viewMode === 'PREVIEW' ? 'bg-white dark:bg-zinc-800 text-brand-600 shadow-sm' : 'text-zinc-500 hover:text-zinc-700'}`}
            >
              <Eye size={12} /> Preview
            </button>
          </div>
      ...
      {viewMode === 'PREVIEW' ? (
        <div className="animate-in zoom-in-95 duration-300">
          <ArticlePreviewAtom content={article.content} title={article.title} />
        </div>
      ) : (
