...
export default function HomeContentPage() {
  ...
  return (
    <div className="flex h-full overflow-hidden bg-zinc-50 dark:bg-black">
      ...
      <div className="w-[300px] xl:w-[350px] border-r border-zinc-200 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-900/20 overflow-y-auto hidden lg:block custom-scrollbar shrink-0">
         <div className="p-8 space-y-8">
              ...
              <GlassCard className="p-6 space-y-6 border-brand-500/20">
                 ...
                 <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-[10px] font-bold uppercase tracking-wider text-zinc-500">
                        <span>Heading</span>
                        <span className="text-yellow-500 uppercase">Cek</span>
                      </div>
                      <div className="h-1.5 w-full bg-zinc-200 dark:bg-zinc-800 rounded-full overflow-hidden">
            ...
            <div className="p-6 rounded-2xl bg-zinc-900 border border-zinc-800 space-y-4">
               ...
               <p className="text-[11px] text-zinc-400 leading-relaxed">
                 Perubahan akan langsung memperbarui website publik.
               </p>
            </div>
         </div>
      </div>
          ...
          <div className="sticky top-0 z-30 pt-10 pb-6 bg-white/80 dark:bg-black/80 backdrop-blur-md flex justify-between items-center border-b border-zinc-100 dark:border-zinc-800 mb-8">
            <div>
              ...
              <p className="text-zinc-500 dark:text-zinc-400 font-bold text-[10px] uppercase tracking-wider">
                Seksi: {SECTIONS.find(s => s.id === activeSection)?.label}
              </p>
            </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      <div className="space-y-3">
                          ...
                          <input 
                              ...
                              className="w-full bg-zinc-50 dark:bg-zinc-950 border border-dashed border-zinc-300 dark:border-zinc-700 rounded-xl px-4 py-3 text-sm font-mono text-brand-500 outline-none"
                          />
                      </div>
                      <div className="space-y-3">
      ...
      {/* Column 3: Navigation Sidebar (Right) */}
      <div className="w-[280px] border-l border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 p-6 hidden xl:block overflow-y-auto shrink-0">
        <div className="space-y-8">
                    ...
                    {SECTIONS.map((section) => {
                        ...
                        return (
                            <button
                                ...
                                className={`w-full flex items-center px-4 py-3 rounded-xl transition-all duration-300 group cursor-pointer
                                    ${isActive 
                            ...
                            >
                                ...
                                <ChevronRight size={14} className={`transition-transform duration-300 ${isActive ? 'translate-x-1' : 'opacity-20'}`} />
                            </button>
                        );
                    })}
                </div>
            ...
            <div className="p-6 rounded-2xl bg-brand-500/5 border border-brand-500/10 space-y-4">
                ...
                <p className="text-[11px] text-brand-900/60 dark:text-brand-100/60 leading-relaxed font-medium">
                  Setiap perubahan disimpan untuk seksi yang aktif saja.
                </p>
            </div>
        </div>
      </div>
