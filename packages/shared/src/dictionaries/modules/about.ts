...
import { AboutDictionary, HistoryDictionary, LegalDictionary } from '../../types';
...
export const About_EN: AboutDictionary = {
...
export const History_ID: HistoryDictionary = {
...
export const History_EN: HistoryDictionary = {
...
export const Legal_EN: LegalDictionary = {
