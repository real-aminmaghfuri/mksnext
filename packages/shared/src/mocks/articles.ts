...
export const AUTHORS = {
  FOUNDER: 'Amin Maghfuri',
  TEAM: 'Tim MKS',
} as const;

// --- 2. RAW DATA (The Essence) ---
// Minimalist structure, easy to edit/add new items.
const DATA_SOURCE = [
  {
    id: 1,
    ...
    category: ARTICLE_CATEGORIES.MARKETING,
    date: "25 Oct 2024",
  ...
  },
  {
    ...
    category: ARTICLE_CATEGORIES.TEKNIS,
    date: "20 Oct 2024",
    author: AUTHORS.FOUNDER,
    readTime: "4 MIN READ",
...
// We inject heavy/boilerplate content here, so the raw data remains clean.
...
// --- 4. CONTENT HELPER (The Warehouse) ---
