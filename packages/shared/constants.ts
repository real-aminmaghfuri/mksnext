...
export const DICTIONARY: Record<Language, Translation> = {
  [Language.ID]: {
    ...
    contactQna: [
      { q: "Barang ready stok gak?", a: "Mayoritas ready di Solo. Tapi kalau request spek dewa, kadang harus indent 3-5 hari." },
      { q: "Bisa kirim luar kota?", a: "Bisa banget. Kita udah biasa kirim ke seluruh Indonesia pake packing kayu aman." },
      { q: "Ada garansi gak?", a: "Pasti ada. Hardware garansi 1 tahun, software garansi lifetime selama langganan." },
      { q: "Kalau error gimana?", a: "Chat support kita 24/7. Kalau parah, teknisi kita luncur ke lokasi (area Solo Raya)." }
    ],
  ...
  [Language.EN]: {
    ...
    contactQna: [
      { q: "Items in stock?", a: "Mostly ready in Solo. High-end specs might need 3-5 days indent." },
      { q: "Ship nationwide?", a: "Absolutely. We ship across Indonesia with secure wood packing." },
      { q: "Warranty?", a: "1 Year for Hardware, Lifetime for Software subscription." },
      { q: "Technical support?", a: "24/7 Chat Support. Field technicians available for Solo area." }
    ],
    contactOfficeLegalTitle: "LEGAL OFFICE",
    contactOfficeOpsTitle: "OPS HQ",
    contactLabelWa: "WHATSAPP",
